...
from services.documents.models import Chunk
...
class HybridRetriever:
    ...
    def retrieve(self, query: str, use_keyword: bool = True) -> list[Chunk]:
        # Vector search
        vector_result_chunks = self.vector_store.query(query)
